...
<div class="project-row">📞 <span>Contact:</span> +91-7585073011</div>
...
with col2:
    st.markdown("### **Soumi Takdar**")
    st.markdown("**Project Mentor & Faculty Guide**")
    st.markdown("🎓 **M.Tech – NIT Durgapur**")

    st.markdown("""
    <span class="skill-badge">Machine Learning</span>
    <span class="skill-badge">Data Science</span>
    <span class="skill-badge">Academic Research</span>
    """, unsafe_allow_html=True)

    st.markdown(
        """
        <a href="https://www.linkedin.com/in/soumi-tokdar-820b811ba/" target="_blank">
